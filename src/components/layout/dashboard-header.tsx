...
interface DashboardHeaderProps {
  ...
  /** Rendered before the search trigger — used for in-header view switchers. */
  children?: React.ReactNode
}

/**
 * The canonical dashboard page header.
 *
 * The command palette is wired here rather than by each page: the shell owns
 * the palette state and `openCommandPalette` reaches it through a window
 * event, so every section gets the search trigger for free.
 */
